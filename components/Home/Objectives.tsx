...
const Highlight = (props: Props) => {
	...
	return (
		<span className="group-hover:text-secondary font-bold transition-colors">
			{children}
		</span>
	);
};
...
const Objectives = () => {
	return (
		<div className="min-h-[80vh] px-4 sm:px-24 xl:px-48 py-16 sm:py-24 bg-gray-800 flex border-t-8 border-b-8 border-primary">
			<div
				className="text-white flex-grow flex flex-col gap-8 sm:gap-32 justify-between items-center invisible"
				data-animate
			>
				<h2 className="text-4xl font-semibold uppercase">Nos objectifs</h2>
